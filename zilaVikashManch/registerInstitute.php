                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" method="post" class="needs-validation" novalidate>
                            ...
                            <div class="mb-2">
                                <div class="form-floating">
                                    <input type="text" placeholder="Est_year" name="est_year" class="form-control" required>
                                    <label for="">Establish year</label>
                                    <div class="invalid-feedback">
                                    Please enter your establish year
                                </div>
                                </div>
                            </div>
                            <div class="mb-2">
                                <div class="form-floating">
                                    <input type="text" placeholder="board_name" name="board_name" class="form-control" required>
                        ...
                        <?php
                           if (isset($_POST['create'])) {
                               ...
                               $query = mysqli_query($connect,"insert into accounts (name,contact,email,est_year,board_name,password,type) value ('$name','$contact','$email','$est_year','$board_name','$password','$type')");
                               if ($query) {
