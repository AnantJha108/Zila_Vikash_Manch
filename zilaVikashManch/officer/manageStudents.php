    ...
    <div class="container-fluid p-0">
        <div class="row g-0">
            ...
            <div class="col-10 p-4">
                <div class="row">
                    <div class="col-12">Manage Students/Candidate</div>
                </div>
                <table class="table mt-3">
                    ...
                    <?php
                    $callingStudents=mysqli_query($connect,"select * from accounts where type='0'");
                    while ($row=mysqli_fetch_array($callingStudents)) {?>
                        <tr>
                        <td><?=$row['id'];?></td>
                        <td><?=$row['name'];?></td>
                        <td><?=$row['contact'];?></td>
