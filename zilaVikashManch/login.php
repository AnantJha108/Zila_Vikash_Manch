...
<head>
    ...
    <title>Login Here - Zila Vikash Manch</title>
    <!-- CSS only -->
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-5 mx-auto">
                <div class="card">
                    <div class="card-header">Login Here for Institute/Candidite</div>
                    <div class="card-body">
                    ...
                    <a href="register.php" class="nav-link float-start p-0 small text-muted p-0 m-0">New User?</a>
